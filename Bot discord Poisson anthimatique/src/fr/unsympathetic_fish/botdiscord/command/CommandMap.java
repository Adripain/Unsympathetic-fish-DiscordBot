...
import fr.unsympathetic_fish.botdiscord.command.defaut.CommandDefault;
import fr.unsympathetic_fish.botdiscord.command.defaut.HelpCommand;
...
public final class CommandMap {
    ...
    public CommandMap(BotDiscord botDiscord) {
    	...
    	registerCommands(new CommandDefault(botDiscord), new HelpCommand(this));
    }
    ...
    public void commandConsole(String command){
        ...
        if(object[0] == null || ((SimpleCommand)object[0]).getExecutorType() == ExecutorType.USER){
            System.out.println("Commande inconnue."); //https://gph.is/175t90L
            return;
        }
        try{
